...
icon = Image.open(r"D:\My files\Nagammai\Guvi\MDE86\code\icon.jpg")
...
if selected == "Home":
    ...
    with col2:
        icon_path = "D:/My files/Nagammai/Guvi/MDE86/code/icon.jpg"  # Update the path to your icon file
        if os.path.exists(icon_path):
            icon_bytes = open(icon_path, 'rb').read()
            st.image(icon_bytes, caption='BizCardX', width=150)
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        # Define the save_card function
        def save_card(uploaded_card):
            # Define the directory path where the card will be saved
            directory = "D:\\My files\\Nagammai\\Guvi\\MDE86\\code\\uploaded_cards"
            
            # Create the directory if it doesn't exist
            if not os.path.exists(directory):
                os.makedirs(directory)
            
            # Save the uploaded image into the directory
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img_path = "D:\\My files\\Nagammai\\Guvi\\MDE86\\code\\uploaded_cards\\" + uploaded_card.name
        ...
        def save_card(uploaded_card):
            if uploaded_card is not None:
                file_path = "D:\\My files\\Nagammai\\Guvi\\MDE86\\code\\uploaded_cards\\" + uploaded_card.name
        ...
        saved_img_path = "D:\\My files\\Nagammai\\Guvi\\MDE86\\code\\uploaded_cards\\" + uploaded_card.name
        result = reader.readtext(saved_img_path, detail=0, paragraph=False)
        ...
        data = {"company_name" : [],
                ...
                "state" : [],
                "pin_code" : [],
                "image" : img_to_binary(saved_img_path)
               }
